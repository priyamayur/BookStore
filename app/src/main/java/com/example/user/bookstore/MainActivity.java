...
public class MainActivity extends AppCompatActivity implements
    ...
    private void insertBook() {
        ...
        values.put(BookEntry.COLUMN_BOOK_NAME, "Terrier");
        values.put(BookEntry.COLUMN_BOOK_PRICE, 200 );
        values.put(BookEntry.COLUMN_BOOK_QUANTITY, 30);
        values.put(BookEntry.COLUMN_SUPPLIER_NAME, "Rajat Basu");
        values.put(BookEntry.COLUMN_SUPPLIER_PHONE, "9163924211");
